...
import Imageval from '../../assets/tree.jpg';
import test from '../../assets/mio4.jpg';

const PublicProfile = () => {
    return(
        <div style={{ backgroundImage: `url(${Imageval})`, backgroundSize: 'cover' }} className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover overflow-hidden h-screen">
            <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                <div id="profile"
                    ...
                    <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style={{backgroundImage: `url(${test})`}}></div>
                        <h1 className="text-3xl font-bold pt-8 lg:pt-0">Pooria Rahimi</h1>
                        <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25" ></div>
                        <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">

                            <svg className="h-4 fill-current text-green-700 pr-4"
                                viewBox="0 0 20 20">
                                <path
