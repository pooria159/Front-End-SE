...
const Card = ({data}) => {
  ...
  return (
    <div className="max-w-md h-[22rem] mx-md bg-white rounded-xl shadow-md overflow-hidden md:max-w-[27rem] m-2">
      <div className="md:flex h-full">
        ...
        <div className="p-5">
          ...
          <p className="h-[3rem] mt-2 text-gray-500 text-sm border-t">{data.Description.substring(0, 90) + (data.Description.length > 90 ? "..." : "")}</p>
