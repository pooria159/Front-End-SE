      ...
      <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            <a href="#" aria-current="page" class="relative z-10 inline-flex items-center bg-indigo-500 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">1</a>
...
const sortOptions = [
  { name: 'ehem1', href: '#', current: true },
  { name: 'ehem2', href: '#', current: false },
  { name: 'ehem3', href: '#', current: false },
  { name: 'ehem4', href: '#', current: false },
  { name: 'ehem5', href: '#', current: false },
]
const subCategories = [
  { name: 'Cat1', href: '#' },
  { name: 'Cat2', href: '#' },
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1s gap-x-1 gap-y-10 lg:grid-cols-7">
              ...
              {/* Product grid */}
              <div className='lg:col-span-6 justify-center items-center space-y-5'>
