  ...
  return (
    <div>
      <div class="w-full h-screen flex flex-col items-center justify-center bg-indigo-300">
        ...
        >
          <circle cx="292.60911" cy="213" r="213" fill="#3949AB"></circle>
          <path
        ...
        <a
          onClick={() => navigate("/")}
          className="flex items-center space-x-2 bg-[#3949AB] hover:bg-indigo-800 text-gray-100 px-4 py-2 mt-12 rounded transition duration-150"
          title="Return Home"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
